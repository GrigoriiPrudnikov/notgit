...
// 	if err := os.MkdirAll(filepath.Join(tempDir, ".notgit", "objects"), 0o755); err != nil {
// 		t.Fatal(err)
// 	}
//
...
// 		t.Fatal(err)
// 	}
// 	if err := os.WriteFile(filepath.Join(objDir, commitHash[2:]), commitCompressed, 0o644); err != nil {
// 		t.Fatal(err)
// 	}
//
...
// 		t.Fatal(err)
// 	}
// 	if err := os.WriteFile(filepath.Join(objDir, blobHash[2:]), blobCompressed, 0o644); err != nil {
// 		t.Fatal(err)
// 	}
//
...
// 		t.Fatal(err)
// 	}
// 	if err := os.WriteFile(filepath.Join(headDir, "HEAD"), []byte(commitHash), 0o644); err != nil {
// 		t.Fatal(err)
// 	}
//
...
// 	if err = os.MkdirAll(filepath.Join(tempDir, ".notgit"), 0o755); err != nil {
// 		t.Fatal(err)
// 	}
// 	if err = os.WriteFile(filepath.Join(tempDir, ".notgit", "index"), []byte(""), 0o644); err != nil {
// 		t.Fatal(err)
// 	}
//
// 	// NewCommit may return nil if LoadStaged fails, or a commit with empty tree
// 	c, err := commit.NewCommit("msg", "author", strings.Repeat("a", 64))
// 	if err != nil {
